...
# class same with train_file(.ipynb)
...
# only for merging 
load_dir = r"C:\Users\bell9\OneDrive\바탕 화면\deep\pt-checkpoints\last_model.pt"
l_model = Dynamic_predict()
l_model.load_state_dict(torch.load(load_dir))
